      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground">
            Help return a found item to its owner by sharing details
          </p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <input
                ...
                onChange={handleChange}
                placeholder="e.g., Library 3rd floor, Student Center Cafe"
                className="w-full px-4 py-3 rounded-xl border border-input bg-background text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all"
                required
              />
            </div>
            ...
            <div className="space-y-3">
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe the item in detail (condition, color, brand, any identifying marks, etc.)"
                rows={5}
            ...
            <div className="flex gap-4 pt-4">
              <button
                ...
                className="flex-1 px-6 py-3 bg-secondary text-white rounded-xl font-semibold hover:bg-secondary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-lg hover:shadow-xl"
              >
